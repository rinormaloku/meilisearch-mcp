            ...
            return [
                ...
                types.Tool(
                    ...
                    inputSchema={
                        ...
                        "properties": {
                            "indexUid": {"type": "string"},
                            "template": {"type": "string", "enum": ["ecommerce", "content_search", "saas_app"]}
                        },
        ...
        async def handle_call_tool(name: str, arguments: Optional[Dict[str, Any]] = None) -> list[types.TextContent]:
            ...
            try:
                if name == "create-index":
                    ...
                    return [types.TextContent(
                        type="text",
                        text=f"Current settings: {settings}"
                    )]
                    ...
                    return [types.TextContent(
                        type="text",
                        text=f"Settings updated: {result}"
                    )]
                    ...
                    self.logger.info("Index metrics retrieved", 
                                   index=arguments["indexUid"],
                                   metrics=metrics.__dict__)
                    return [types.TextContent(
                        type="text",
                        text=f"Index metrics: {metrics.__dict__}"
                    )]
                    ...
                    return [types.TextContent(
                        type="text",
                        text=f"System information: {info}"
                    )]
                ...
                self.logger.error(f"Error executing tool {name}",
                                error=str(e),
                                tool=name,
                                arguments=arguments)
                return [types.TextContent(
...
def main():
    ...
    server = MeilisearchMCPServer(url, api_key)
